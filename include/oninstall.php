 ...
 */
function xoops_module_pre_install_mastoppublish(\XoopsModule $module)
{
    include __DIR__ . '/../preloads/autoloader.php';
    /** @var Mastoppublish\Utility $utility */
    $utility = new \XoopsModules\Mastoppublish\Utility();
 ...
 */
function xoops_module_install_mastoppublish(\XoopsModule $module)
{
