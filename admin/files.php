...
switch ($op) {
    case 'files_editar':
        ...
        $fil_classe = new Mastoppublish\FilFiles($fil_10_id);
    ...
    case 'salvar':
        if (empty($fil_10_id)) {
            $files = new Mastoppublish\FilFiles();
        } else {
            $files = new Mastoppublish\FilFiles($fil_10_id);
        }
        $erro      = '';
    ...
    default:
        ...
        $FilFiles = new Mastoppublish\FilFiles();
