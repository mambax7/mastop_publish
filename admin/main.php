...
switch ($op) {
    case 'limpacont':
        ...
        $mpu_classe = new Mastoppublish\Publish($mpb_10_id);
    ...
    case 'limpacont_ok':
        ...
        if (!$mpu_classe->store()) {
            redirect_header(XOOPS_URL . '/modules/' . MPU_MOD_DIR . '/admin/main.php', 3, MPU_ADM_ERRO1);
        } else {
            redirect_header(XOOPS_URL . '/modules/' . MPU_MOD_DIR . '/admin/main.php?op=listar_editar&mpb_10_id=' . $mpb_10_id, 3, MPU_ADM_SUCESS1);
        }
        break;
    case 'novo':
        mpu_adm_menu();
        ...
        break;
    case 'salvar':
        $mpu_classe = (isset($mpb_10_id) && $mpb_10_id > 0) ? new Mastoppublish\Publish($mpb_10_id) : new Mastoppublish\Publish();
        ...
        $mpu_classe->setVar('mpb_35_conteudo', ((isset($mpb_12_semlink) || isset($mpb_frame) || isset($mpb_pagina)
                                                 || empty($mpb_35_conteudo)) ? '' : $mpb_35_conteudo));
        ...
        if (empty($mpb_10_id)) {
            $mpu_classe->setVar('mpb_22_criado', time());
        }
        $mpu_classe->setVar('mpb_22_atualizado', time());
        ...
        if (!$mpu_classe->store()) {
            ...
            if (isset($mpb_10_id) && $mpb_10_id > 0) {
            ...
            redirect_header(XOOPS_URL . '/modules/' . MPU_MOD_DIR . '/admin/main.php', 3, MPU_ADM_SUCESS1);
        }
        break;
    case 'listar_clone':
        $mpb_10_id  = (!empty($mpb_10_id)) ? $mpb_10_id : 0;
    ...
    case 'listar_all':
        if (empty($_POST['campos'])) {
            ...
            $c['botoes'][1]['link']   = XOOPS_URL . '/modules/' . MPU_MOD_DIR . '/admin/main.php?op=listar_editar';
            $c['botoes'][1]['imagem'] = $pathIcon16 . '/edit.png';//'images/editar.gif';
            $c['botoes'][1]['texto']  = _EDIT;

            $c['botoes'][2]['link']   = XOOPS_URL . '/modules/' . MPU_MOD_DIR . '/admin/main.php?op=listar_deletar';
            $c['botoes'][2]['imagem'] = $pathIcon16 . '/delete.png';//'images/deletar.gif';
            ...
            echo $mpu_classe->administracao(XOOPS_URL . '/modules/' . MPU_MOD_DIR . '/admin/main.php', $c);
            ...
            foreach ($_POST['campos'] as $k => $v) {
                $mpu_classe = new Mastoppublish\Publish($k);
                $mpu_classe->assignVars($v);
                $mpu_classe->store();
            }
            redirect_header(XOOPS_URL . '/modules/' . MPU_MOD_DIR . '/admin/main.php?op=listar_all', 3, MPU_ADM_SUCESS2);
        }
        break;
    case 'listar':
    default:
        if (empty($_POST['campos'])) {
            ...
            $c['botoes'][2]['link']   = XOOPS_URL . '/modules/' . MPU_MOD_DIR . '/admin/main.php?op=listar_clone';
            $c['botoes'][2]['imagem'] = $pathIcon16 . '/editcopy.png';//'images/clone.gif';
            $c['botoes'][2]['texto']  = _CLONE;

            $c['botoes'][3]['link']   = XOOPS_URL . '/modules/' . MPU_MOD_DIR . '/admin/main.php?op=listar_deletar';
            $c['botoes'][3]['imagem'] = $pathIcon16 . '/delete.png';//'images/deletar.gif';
            ...
            redirect_header(XOOPS_URL . '/modules/' . MPU_MOD_DIR . '/admin/main.php?op=listar', 3, MPU_ADM_SUCESS2);
        }
